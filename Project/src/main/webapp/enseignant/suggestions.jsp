                ...
                <div class="col-12 col-lg-6">
                    <div class="login-content bg-white p-30 box-shadow">
                        ...
                        <div class="section-heading">
                            <h5>CI JOINT QUELQUES SUGGESTIONS</h5>
                        </div>

                     <h4 style="margin-top: 2em;"><label for="size">Suggéstions :</label></h4>
                    <form:form method="POST" modelAttribute="suggestionForm" action="${contextPath}/enseignant/suggestions" class="form-signin">
                        <select name='role'>
