                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Devoir Surveillé</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="login-content bg-white p-30 box-shadow">
                        ...
                        <div class="section-heading">
                            <h5>CREEZ VOTRE DEMANDE DE DS!</h5>
                        </div>

   <form:form method="POST" modelAttribute="DsForm" action="${contextPath}/enseignant/devoirsurveille" class="form-signin">
        ...
        <div class="form-group ${error != null ? 'has-error' : ''}">
            ...
            <form:input path="Date_debut" type="text" class="form-control" placeholder= "DateDebut:aaaa-mm-jjThh:mm:ss"></form:input>
             ...
             <form:select path="groupes.groupeN" items="${groupes}"/>
              </div>
             <div class="form-group" id="element">
            <span>${error}</span>
