                ...
                <nav class="classy-navbar justify-content-between" id="magNav">
                    ...
                    <div class="nav-content d-flex align-items-center">
                            ...
                            <div class="classynav">
                                <ul>
                                    <li class="indent"><a href="#">Espace Admin</a>
                                        <ul class="dropdown">
                                            <li><a href="#">Gerer Etudiants</a></li>
                                            <li><a href="#">Gerer Enseignants</a></li>
                        ...
                        <div class="classynav">
                           ...
                           <div class="dropdown">
                                            <ul class="single-mega cn-col-4">
                                                <li><a href="/enseignant/profilEnseignant">Enseignant</a></li>
    ...
    <section class="contact-area">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-xl-8">
                    <div class="contact-content-area bg-white mb-30 p-30 box-shadow">
                        ...
                        <div class="contact-information mb-30">
                            <p>L'École nationale des sciences de l'informatique (arabe : المدرسة الوطنيّة لعلوم الإعلامية) ou ENSI est une école tunisienne formant des ingénieurs dans les technologies de l'information et de la communication.Fondée en septembre 1984 par Habib Bourguiba Jr. et le professeur Mohamed Ben Ahmed, elle s'est installée sur l'avenue Mohammed V à Tunis puis à la Charguia II avant d'emménager dans les nouveaux locaux qui se situent sur le campus de La Manouba (près de Tunis) à la rentrée 2000. C'est en anticipant cet emménagement que l'école intègre en 1999 la nouvelle Université de La Manouba qui vient d'être créée.</p>
               ...
               <div class="post-sidebar-area right-sidebar mt-60 mb-30 box-shadow">
            <!-- Sidebar Widget -->
