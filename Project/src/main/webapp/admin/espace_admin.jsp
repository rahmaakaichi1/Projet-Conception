                            ...
                            <div class="classynav">
                                <ul>
                                    <li class="indent"><a href="#">Espace Admin</a>
                                        <ul class="dropdown">
                                            <li><a href="/admin/gestionEnseignants">Gerer Etudiants</a></li>
                                            <li><a href="/admin/gestionEtudiants">Gerer Enseignants</a></li>
                                    ...
                                    <li class="indent"><a href="/admin/apropos">A propos</a></li>
                                    <li class ="indent"><a href="/admin/contact">Contact</a></li>
                                </ul>
                            </div>
                            <!-- Nav End -->
                        </div>
